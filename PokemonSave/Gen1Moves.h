...
namespace Gen1
{
	...
	const Move Move_List[] =
	{
		...
		{"Night Shade",Pokemon::Ghost,Move::Special,15,0,100},
		{"Mimic",Pokemon::Normal,Move::Status,40,0,100},
		{"Screech",Pokemon::Normal,Move::Status,40,0,85},
		{"Double Team",Pokemon::Normal,Move::Status,15,0,0},
		{"Recover",Pokemon::Normal,Move::Status,20,0,0},
		{"Harden",Pokemon::Normal,Move::Status,30,0,0},
		{"Minimize",Pokemon::Normal,Move::Status,20,0,0},
		{"Smokescreen",Pokemon::Normal,Move::Status,20,0,100},
		{"Confuse Ray",Pokemon::Ghost,Move::Status,10,0,100},
		{"Withdraw",Pokemon::Water,Move::Status,40,0,0},
		{"Defense Curl",Pokemon::Normal,Move::Status,40,0,0},
		{"Barrier",Pokemon::Psychic,Move::Status,30,0,0},
		{"Light Screen",Pokemon::Psychic,Move::Status,30,0,0},
		{"Haze",Pokemon::Ice,Move::Status,30,0,0},
		{"Reflect",Pokemon::Psychic,Move::Status,20,0,0},
		{"Focus Energy",Pokemon::Normal,Move::Status,30,0,0},
		{"Bide",Pokemon::Normal,Move::Physical,10,0,100},
		{"Metronome",Pokemon::Normal,Move::Status,10,0,0},
		{"Mirror Move",Pokemon::Flying,Move::Status,20,0,0},
		{"Self-Destruct",Pokemon::Normal,Move::Physical,5,130,100},
		{"Egg Bomb",Pokemon::Normal,Move::Physical,10,100,75},
		{"Lick",Pokemon::Ghost,Move::Physical,30,20,100},
		{"Smog",Pokemon::Poison,Move::Special,20,20,70},
		{"Sludge",Pokemon::Poison,Move::Special,20,65,100},
		{"Bone Club",Pokemon::Ground,Move::Physical,20,65,85},
		{"Fire Blast",Pokemon::Fire,Move::Special,5,120,85},
		{"Waterfall",Pokemon::Water,Move::Physical,15,80,100},
		{"Clamp",Pokemon::Water,Move::Physical,10,35,75},
		{"Swift",Pokemon::Normal,Move::Special,20,60,0},
		{"Skull Bash",Pokemon::Normal,Move::Physical,15,100,100},
		{"Spike Cannon",Pokemon::Normal,Move::Physical,15,20,100},
		{"Constrict",Pokemon::Normal,Move::Physical,35,10,100},
		{"Amnesia",Pokemon::Psychic,Move::Status,20,0,0},
		{"Kinesis",Pokemon::Psychic,Move::Status,15,0,80},
		{"Soft-Boiled",Pokemon::Normal,Move::Status,10,0,0},
		{"High Jump Kick",Pokemon::Fight,Move::Physical,20,85,90},
		{"Glare",Pokemon::Normal,Move::Status,30,0,75},
		{"Dream Eater",Pokemon::Psychic,Move::Special,15,100,100},
		{"Poison Gas",Pokemon::Poison,Move::Status,40,0,55},
		{"Barrage",Pokemon::Normal,Move::Physical,20,15,85},
		{"Leech Life",Pokemon::Bug,Move::Physical,15,20,100},
		{"Lovely Kiss",Pokemon::Normal,Move::Status,10,0,75},
		{"Sky Attack",Pokemon::Flying,Move::Physical,5,140,90},
		{"Transform",Pokemon::Normal,Move::Status,10,0,0},
		{"Bubble",Pokemon::Water,Move::Special,10,0,0},
		{"Dizzy Punch",Pokemon::Normal,Move::Physical,10,70,100},
		{"Spore",Pokemon::Grass,Move::Status,15,0,100},
		{"Flash",Pokemon::Normal,Move::Status,20,0,80},
		{"Psywave",Pokemon::Psychic,Move::Special,15,0,80},
		{"Spalsh",Pokemon::Normal,Move::Status,40,0,0},
		{"Acid Armor",Pokemon::Poison,Move::Status,40,0,0},
		{"Crabhammer",Pokemon::Water,Move::Physical,10,90,85},
		{"Explosion",Pokemon::Normal,Move::Physical,5,170,100},
		{"Fury Swipes",Pokemon::Normal,Move::Physical,15,18,80},
		{"Bonemerang",Pokemon::Ground,Move::Physical,10,50,90},
		{"Rest",Pokemon::Psychic,Move::Status,10,0,0},
		{"Rock Slide",Pokemon::Rock,Move::Physical,10,75,90},
		{"Hyper Fang",Pokemon::Normal,Move::Physical,15,80,90},
		{"Sharpen",Pokemon::Normal,Move::Status,30,0,0},
		{"Conversion",Pokemon::Normal,Move::Status,30,0,0},
		{"Tri Attack",Pokemon::Normal,Move::Special,10,80,100},
		{"Super Fang",Pokemon::Normal,Move::Physical,10,0,90},
		{"Slash",Pokemon::Normal,Move::Physical,20,70,100},
		{"Substitute",Pokemon::Normal,Move::Status,10,0,0},
		{"Struggle",Pokemon::Normal,Move::Physical,10,50,100}
	};
}